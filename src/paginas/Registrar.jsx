...
const Registrar = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (password.length <= 6) {
            setAlerta({ msg: 'El Password es muy corto, agrega minimo 7 caracteres', error: true });
            return;
        }

        setAlerta({});

        // Crear el usuario en la API - BACKEND
        try {
    ...
    return (
        <>
            ...
            <div className='mt-20 md:mt-4 shadow-lg px-5 py-10 rounded-xl bg-white'>
